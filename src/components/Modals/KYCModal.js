...
export const KycVerify = ({ onClose, isOpen }) => {
  ...
  const { mutate, isLoading } = useMutation((data) => kyc(data), {
    onSuccess: (data) => {
      console.log(data);
      onOpenKyc();
    },
  ...
  const onSubmit = (data) => {
    ...
    data.idType = parseInt(data.idType);
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {occupation?.map((types, index) => (
                        <option value={index} key={types}>
                          {types}
                        </option>
                      ))}
                    </Select>
                ...
                >
                  ...
                  >
                    ...
                    <Input
                      ...
                      {...register("bvn")}
                    />
                    <FormErrorMessage>{errors?.bvn?.message}</FormErrorMessage>
                  </FormControl>
                </GridItem>
                <GridItem
                  colSpan="8"
